				...
				<div className="flex items-center justify-between">
					<CardTitle className="text-xl font-semibold">
						{incident.incident_type.charAt(0) +
							incident.incident_type.slice(1).toLowerCase()} Incident
					</CardTitle>
						...
						<div>
							...
							<div className="flex items-center gap-2 text-sm">
								...
								<p className="font-medium">
									...
									<Link href={`https://maps.google.com/?q=${incident.latitude},${incident.longitude}`} target='_blank'>
										<Button className='ml-2'>Navigate <ExternalLink /></Button>
									</Link>
								</p>
							</div>
						</div>
